...
function SidebarOrg () {
  return (
    <div className="sidebar-org">
        ...
        <NavLink to="/dashboard/organization" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
          <img src={Dashboard} alt="dashboard-icon" className="dash-icon-org" />
          <p>Dashboard</p>
        </NavLink>

        <NavLink to="/dashboard/organization/opportunities" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
          <img src={Opportunities} alt="opportunities-icon" className="dash-icon-org" />
          <p>Opportunities</p>
        </NavLink>

        <NavLink to="/dashboard/organization/applications" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
          <img src={Applications} alt="applications-icon" className="dash-icon-org" />
          <p>Applications</p>
        </NavLink>

        <NavLink to="/dashboard/organization/messages" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
          <img src={Messages} alt="messages-icon" className="dash-icon-org" />
          <p>Messages</p>
        </NavLink>

        <NavLink to="/dashboard/organization/history" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
          <img src={History} alt="history-icon" className="dash-icon-org" />
          <p>History</p>
        </NavLink>

        <NavLink to="/dashboard/organization/settings" className={({ isActive }) => isActive ? "sideElements-org active" : "sideElements-org" }>
